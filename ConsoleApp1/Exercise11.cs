...
namespace ConsoleApp1
{
    class Exercise11
    {
        public static void NumbersConvertToWords()
        {
            Console.Write("Exercise11:  Write a program that converts a number in the range [0…999] to words, corresponding to the English pronunciation. " +
                          "Examples: " +
                          "- 0 --> Zero \n" +
                          "- 12 --> Twelve \n" +
                          "- 98 --> Ninety eight \n" +
